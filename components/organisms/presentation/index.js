  ...
  return (
    <Container>
      <Section>
        ...
        <Text>
        Através do nosso aplicativo, proporcionamos de forma gratuita
        acesso à educação de qualidade na linguagem da quebrada para formar protagonistas do futuro.
        </Text>
